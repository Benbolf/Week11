...
private void deleteProject() {
    ...
    Integer projectIDd = getIntInput("Enter the ID of the project to delete");
...
private void updateProjectDetails() {
    ...
    Integer difficulty =
        getIntInput("Enter the actual hours [" + curProject.getDifficulty() + "]");   
    ...
    project.setProjectName(Objects.isNull(projectName) ? cur.project.getProjectName() : projectName);
